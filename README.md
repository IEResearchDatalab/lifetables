...
- [`compute_mortality_multiplier_by_age.R`](./compute_mortality_multiplier_by_age.R)
  - `mortality_multiplier_by_age` contains columns "component" (Heat, Cold or Total), "year", "age", "avg_rr" (climate-adjusted RR), "multiplier" (proportion between climate-adjusted RR and baseline RR), "year_label" (numeric).

- [`compute_cohort_lifetable_financial.R`](./compute_cohort_lifetable_financial.R)
  - `cohort_lifetable_climate` contains columns "age", "year", "rcp", "adaptation" (in percentage), "qx_base" (baseline death probability), "qx_clim" (climate-adjusted death probability), "mx_base" (baseline mortality rate), "mx_clim" (climate-adjusted mortality rate), "multiplier" (proportion between climate-adjusted RR and baseline RR), "lx_base" (number of survivors), "lx_clim", "dx_base" (number of deaths), "dx_clim".
  ...
  - `temp_distribution_baseline` contains columns "temp_bin" (integer), "n_days", "proportion". This represents the distribution of daily mean temperatures in the baseline period (1990-2019) for the city, binned into 1°C intervals.
