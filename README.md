...
- [`compute_cohort_lifetable_financial.R`](./compute_cohort_lifetable_financial.R)
  ...
  - `baseline_temp_distribution` contains columns "temp_bin" (integer), "n_days", "proportion". This represents the distribution of daily mean temperatures in the baseline period (1990-2019) for the city, binned into 1°C intervals.
